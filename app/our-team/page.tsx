...
import Aditi from "../assests/aditi digital.jpeg";
import sandeep from "../assests/sandeep-2.png";
import shivani from "../assests/shivani digital.jpeg";
  ...
  const teamMembers = [
    {
      ...
      image: ceoPZI.src,
      bio: "Leading PAYZONINDIA's vision with 12+ years of Technical expertise",
    ...
    },
    {
      ...
      image: MainshSen.src,
      bio: "Leading PAYZONINDIA's vision with 8+ years of Technical expertise",
      linkedin: "https://www.linkedin.com/company/payzonindiabhopal/",
      twitter: "https://twitter.com/payzonindia",
      email: "info@payzonindia.com",
      whatsapp: "+91 755 485 9540",
    ...
    },
    {
      ...
      bio: "Leading PAYZONINDIA's vision with 7+ years of Technical expertise",
      linkedin: "https://www.linkedin.com/company/payzonindiabhopal/",
      twitter: "https://twitter.com/payzonindia",
      email: "info@payzonindia.com",
      whatsapp: "+91 755 485 9540",
    ...
    //   image: RamSir.src,
    //   bio: "Leading PAYZONINDIA's vision with 2+ years of Technical expertise",
    //   linkedin: "https://www.linkedin.com/company/payzonindiabhopal/",
    //   twitter: "https://twitter.com/payzonindia",
    //   email: "info@payzonindia.com",
    //   whatsapp: "+91 755 485 9540",
    ...
    // },
    {
      ...
      image: AshishImg.src,
      bio: "Leading PAYZONINDIA's vision with 1+ years of Technical expertise",
      linkedin: "https://www.linkedin.com/company/payzonindiabhopal/",
      twitter: "https://twitter.com/payzonindia",
      email: "info@payzonindia.com",
      whatsapp: "+91 755 485 9540",
    ...
    {
      name: "Sandeep Rajput",
      specialization: "Digital-Marketing,Social Welfare,",
  qualification: "BA, Certified Digital Marketing & SEO Specialist"  ,
      category: "D-Marketing,Social Welfare",
      image: sandeep.src,
      bio: "Leading PAYZONINDIA's vision with 2+ years of expertise",
      linkedin: "https://www.linkedin.com/company/payzonindiabhopal/",
      twitter: "https://twitter.com/payzonindia",
      email: "info@payzonindia.com",
      whatsapp: "+91 755 485 9540",
      ...
      {
      name: "Aditi Shukla",
      specialization: "Digital-Marketing,Social Management",
    qualification: "BA, Certified Content Creator & Graphic Designer",
      category: "Marketing,Social Welfare,Management",
      image: Aditi.src,
      bio: "Leading PAYZONINDIA's vision with 1+ years of expertise",
      linkedin: "https://www.linkedin.com/company/payzonindiabhopal/",
      twitter: "https://twitter.com/payzonindia",
      email: "info@payzonindia.com",
      whatsapp: "+91 755 485 9540",
    ...
    {
      name: "Shivani Rajak",
      specialization: "Sales And Marketing,Social Welfare,",
  qualification: "BBA, Sales & Marketing Professional"  ,
      category: "D-Marketing,Social Welfare",
      image: shivani.src,
      bio: "Leading PAYZONINDIA's vision with 2+ years of expertise",
      linkedin: "https://www.linkedin.com/company/payzonindiabhopal/",
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 py-16 md:py-24 px-4 md:px-6">
        ...
        <div className="relative max-w-7xl mx-auto text-center pt-32 md:pt-44 pb-8 md:pb-10">
          ...
          <p className="text-base md:text-xl text-indigo-100 max-w-3xl mx-auto leading-relaxed animate-fade-in-up animation-delay-200 px-4">
            The brilliant minds behind PAYZONINDIA's success, driving
